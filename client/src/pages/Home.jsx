...
const Home = () => {
  ...
  const stats = [
    { value: 25, suffix: "K+", label: "Citizens Registered" },
    { value: 42, suffix: "K+", label: "Complaints Resolved" },
    { value: 217, suffix: "", label: "Local Governments" },
...
<div className="flex flex-col md:flex-row items-center justify-between py-12 md:py-24 gap-12">
  ...
  >
    <div className="relative bg-gradient-to-br from-nepal-blue to-nepal-red rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="py-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div 
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-3xl font-bold text-nepal-blue mb-4">In Partnership With</h2>
            <p className="text-gray-600">
              Working with local governments across Nepal to improve civic services
            </p>
          </motion.div>
          ...
          >
            {["Kathmandu", "Pokhara", "Lalitpur", "Bhaktapur"].map((city, index) => (
              <div 
                key={index}
                className="bg-white p-6 rounded-xl shadow-md h-24 flex items-center justify-center transition-transform hover:scale-105"
              >
